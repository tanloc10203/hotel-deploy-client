...
export default function Register() {
  ...
  const isRegisterHotelMode = Boolean(key);
  ...
  const handleSumbit = (value) => {
    ...
    // * customer register
    if (!isRegisterHotelMode) {
      dispatch(authActions.signUpStart(value));
    } else {
      // * register post hotels.
      const data = {
        ...value,
        role: config.user.role.HOTEL,
      };

      dispatch(authActions.signUpHotelStart(data));
    }
  };
      ...
      <RootStyle>
        ...
        <Container>
          <ContentStyle>
            ...
            {!isRegisterHotelMode && <AuthSocial />}
